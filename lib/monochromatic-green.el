;; monochromatic-green Colour Theme
;;
...
(defun color-theme-monochromatic-green ()
  ...
  (color-theme-install
   '(color-theme-monochromatic-green
     ...
     (font-lock-builtin-face ((t (:foreground "#009A00"))))
     (font-lock-comment-face ((t (:italic t :foreground "#515A51"))))
     (font-lock-constant-face ((t (:foreground "#009A00"))))
     (font-lock-doc-face ((t (:italic t :foreground "#4A544A"))))
     (font-lock-function-name-face ((t (:foreground "#009A00"))))
     (font-lock-keyword-face ((t (:foreground "#009A00"))))
     (font-lock-preprocessor-face ((t (:foreground "#009A00"))))
     ...
     (font-lock-variable-name-face ((t (:foreground "#009A00"))))
